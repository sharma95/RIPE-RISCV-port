...
enum inject_params {CREATE_FILE=200, RETURN_ORIENTED_PROGRAMMING};
...
char *opt_inject_params[] = {"nonop", "simplenop", "polynop","returnintolibc","createfile","rop"};


/* 16 code pointers to overwrite */
